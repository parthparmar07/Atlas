...
function ResultDrawer({ result, onClose }: DrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      <div
        className="relative h-full w-full max-w-2xl bg-white dark:bg-slate-800 shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right-full duration-500"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-slate-800 dark:text-slate-100 text-sm">{result.action}</h2>
        ...
        <div className="px-6 py-3 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between">
          ...
          {result.telemetry && (
            <div className="flex items-center gap-3 text-[11px] text-slate-400 font-mono bg-slate-50 dark:bg-slate-900 px-3 py-1 rounded-full border border-slate-200 dark:border-slate-700">
