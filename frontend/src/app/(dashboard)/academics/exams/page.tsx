...
import ExamOpsControl from "@/components/academics/ExamOpsControl";
    ...
    <div className="p-8 max-w-[1700px] mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
         ...
         <ExamOpsControl
            schoolId={actualSchoolId === "all" ? "atlas" : actualSchoolId}
            defaultCourseScope={filteredExams.map((exam) => exam.subject)}
         />
